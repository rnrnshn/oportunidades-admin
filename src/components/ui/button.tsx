...
const buttonVariants = cva(
	"group/button inline-flex shrink-0 items-center justify-center rounded-md border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-2 focus-visible:ring-ring/30 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
	{
		variants: {
			variant: {
				default: "bg-kumo-brand text-white hover:bg-kumo-brand-hover",
				outline:
					"border-kumo-line bg-kumo-base text-kumo-default hover:bg-kumo-tint",
				secondary:
					"bg-kumo-tint text-kumo-default hover:bg-kumo-fill",
				ghost:
					"text-kumo-default hover:bg-kumo-tint hover:text-kumo-default",
				destructive:
					"bg-kumo-danger/10 text-kumo-danger hover:bg-kumo-danger/20",
